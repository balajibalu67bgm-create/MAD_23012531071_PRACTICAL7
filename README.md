...
How to Use
Launch the app: The app will initially load data from the local SQLite database.
Fetch from Network: Tap the "Nw Db" (Network Database) icon in the toolbar to fetch fresh data from the JSON API. The new data will be displayed and saved to the local database.
Fetch from SQLite: Tap the "SQLite Db" icon in the toolbar to load data from the local SQLite database.
